...
[XUI/XUICoreObjects](../wiki/XUI.XUICoreObjects).XImage
...
- [constructor](../wiki/XUI.XUICoreObjects.XImage#constructor)

### Properties

- [\_base\_display](../wiki/XUI.XUICoreObjects.XImage#_base_display)
- [\_children](../wiki/XUI.XUICoreObjects.XImage#_children)
- [\_data\_source](../wiki/XUI.XUICoreObjects.XImage#_data_source)
- [\_format](../wiki/XUI.XUICoreObjects.XImage#_format)
- [\_html](../wiki/XUI.XUICoreObjects.XImage#_html)
- [\_html\_ns](../wiki/XUI.XUICoreObjects.XImage#_html_ns)
- [\_html\_tag](../wiki/XUI.XUICoreObjects.XImage#_html_tag)
- [\_ignore](../wiki/XUI.XUICoreObjects.XImage#_ignore)
- [\_on\_frame\_skip\_data\_source](../wiki/XUI.XUICoreObjects.XImage#_on_frame_skip_data_source)
- [\_type](../wiki/XUI.XUICoreObjects.XImage#_type)
- [text](../wiki/XUI.XUICoreObjects.XImage#text)

### Accessors

- [DOMElementFromHTML](../wiki/XUI.XUICoreObjects.XImage#domelementfromhtml)

### Methods

- [append](../wiki/XUI.XUICoreObjects.XImage#append)
- [attach](../wiki/XUI.XUICoreObjects.XImage#attach)
- [execute](../wiki/XUI.XUICoreObjects.XImage#execute)
- [getDOMObject](../wiki/XUI.XUICoreObjects.XImage#getdomobject)
- [getHTML](../wiki/XUI.XUICoreObjects.XImage#gethtml)
- [hide](../wiki/XUI.XUICoreObjects.XImage#hide)
- [init](../wiki/XUI.XUICoreObjects.XImage#init)
- [log](../wiki/XUI.XUICoreObjects.XImage#log)
- [onCreate](../wiki/XUI.XUICoreObjects.XImage#oncreate)
- [onFrame](../wiki/XUI.XUICoreObjects.XImage#onframe)
- [onMount](../wiki/XUI.XUICoreObjects.XImage#onmount)
- [parse](../wiki/XUI.XUICoreObjects.XImage#parse)
- [setStyle](../wiki/XUI.XUICoreObjects.XImage#setstyle)
- [setText](../wiki/XUI.XUICoreObjects.XImage#settext)
- [show](../wiki/XUI.XUICoreObjects.XImage#show)

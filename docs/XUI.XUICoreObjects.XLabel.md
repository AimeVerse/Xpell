...
[XUI/XUICoreObjects](../wiki/XUI.XUICoreObjects).XLabel
...
- [constructor](../wiki/XUI.XUICoreObjects.XLabel#constructor)

### Properties

- [\_base\_display](../wiki/XUI.XUICoreObjects.XLabel#_base_display)
- [\_children](../wiki/XUI.XUICoreObjects.XLabel#_children)
- [\_data\_source](../wiki/XUI.XUICoreObjects.XLabel#_data_source)
- [\_format](../wiki/XUI.XUICoreObjects.XLabel#_format)
- [\_html](../wiki/XUI.XUICoreObjects.XLabel#_html)
- [\_html\_ns](../wiki/XUI.XUICoreObjects.XLabel#_html_ns)
- [\_html\_tag](../wiki/XUI.XUICoreObjects.XLabel#_html_tag)
- [\_ignore](../wiki/XUI.XUICoreObjects.XLabel#_ignore)
- [\_on\_frame\_skip\_data\_source](../wiki/XUI.XUICoreObjects.XLabel#_on_frame_skip_data_source)
- [\_type](../wiki/XUI.XUICoreObjects.XLabel#_type)
- [text](../wiki/XUI.XUICoreObjects.XLabel#text)

### Accessors

- [DOMElementFromHTML](../wiki/XUI.XUICoreObjects.XLabel#domelementfromhtml)

### Methods

- [append](../wiki/XUI.XUICoreObjects.XLabel#append)
- [attach](../wiki/XUI.XUICoreObjects.XLabel#attach)
- [execute](../wiki/XUI.XUICoreObjects.XLabel#execute)
- [getDOMObject](../wiki/XUI.XUICoreObjects.XLabel#getdomobject)
- [getHTML](../wiki/XUI.XUICoreObjects.XLabel#gethtml)
- [hide](../wiki/XUI.XUICoreObjects.XLabel#hide)
- [init](../wiki/XUI.XUICoreObjects.XLabel#init)
- [log](../wiki/XUI.XUICoreObjects.XLabel#log)
- [onCreate](../wiki/XUI.XUICoreObjects.XLabel#oncreate)
- [onFrame](../wiki/XUI.XUICoreObjects.XLabel#onframe)
- [onMount](../wiki/XUI.XUICoreObjects.XLabel#onmount)
- [parse](../wiki/XUI.XUICoreObjects.XLabel#parse)
- [setStyle](../wiki/XUI.XUICoreObjects.XLabel#setstyle)
- [setText](../wiki/XUI.XUICoreObjects.XLabel#settext)
- [show](../wiki/XUI.XUICoreObjects.XLabel#show)

...
[XUI/XUICoreObjects](../wiki/XUI.XUICoreObjects).XVideo
...
- [constructor](../wiki/XUI.XUICoreObjects.XVideo#constructor)

### Properties

- [\_base\_display](../wiki/XUI.XUICoreObjects.XVideo#_base_display)
- [\_children](../wiki/XUI.XUICoreObjects.XVideo#_children)
- [\_data\_source](../wiki/XUI.XUICoreObjects.XVideo#_data_source)
- [\_format](../wiki/XUI.XUICoreObjects.XVideo#_format)
- [\_html](../wiki/XUI.XUICoreObjects.XVideo#_html)
- [\_html\_ns](../wiki/XUI.XUICoreObjects.XVideo#_html_ns)
- [\_html\_tag](../wiki/XUI.XUICoreObjects.XVideo#_html_tag)
- [\_ignore](../wiki/XUI.XUICoreObjects.XVideo#_ignore)
- [\_on\_frame\_skip\_data\_source](../wiki/XUI.XUICoreObjects.XVideo#_on_frame_skip_data_source)
- [\_type](../wiki/XUI.XUICoreObjects.XVideo#_type)
- [text](../wiki/XUI.XUICoreObjects.XVideo#text)

### Accessors

- [DOMElementFromHTML](../wiki/XUI.XUICoreObjects.XVideo#domelementfromhtml)

### Methods

- [append](../wiki/XUI.XUICoreObjects.XVideo#append)
- [attach](../wiki/XUI.XUICoreObjects.XVideo#attach)
- [execute](../wiki/XUI.XUICoreObjects.XVideo#execute)
- [getDOMObject](../wiki/XUI.XUICoreObjects.XVideo#getdomobject)
- [getHTML](../wiki/XUI.XUICoreObjects.XVideo#gethtml)
- [hide](../wiki/XUI.XUICoreObjects.XVideo#hide)
- [init](../wiki/XUI.XUICoreObjects.XVideo#init)
- [log](../wiki/XUI.XUICoreObjects.XVideo#log)
- [onCreate](../wiki/XUI.XUICoreObjects.XVideo#oncreate)
- [onFrame](../wiki/XUI.XUICoreObjects.XVideo#onframe)
- [onMount](../wiki/XUI.XUICoreObjects.XVideo#onmount)
- [parse](../wiki/XUI.XUICoreObjects.XVideo#parse)
- [setStyle](../wiki/XUI.XUICoreObjects.XVideo#setstyle)
- [setText](../wiki/XUI.XUICoreObjects.XVideo#settext)
- [show](../wiki/XUI.XUICoreObjects.XVideo#show)

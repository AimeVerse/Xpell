...
[XUI/XUICoreObjects](../wiki/XUI.XUICoreObjects).XView
...
- [constructor](../wiki/XUI.XUICoreObjects.XView#constructor)

### Properties

- [\_base\_display](../wiki/XUI.XUICoreObjects.XView#_base_display)
- [\_children](../wiki/XUI.XUICoreObjects.XView#_children)
- [\_data\_source](../wiki/XUI.XUICoreObjects.XView#_data_source)
- [\_format](../wiki/XUI.XUICoreObjects.XView#_format)
- [\_html](../wiki/XUI.XUICoreObjects.XView#_html)
- [\_html\_ns](../wiki/XUI.XUICoreObjects.XView#_html_ns)
- [\_html\_tag](../wiki/XUI.XUICoreObjects.XView#_html_tag)
- [\_ignore](../wiki/XUI.XUICoreObjects.XView#_ignore)
- [\_on\_frame\_skip\_data\_source](../wiki/XUI.XUICoreObjects.XView#_on_frame_skip_data_source)
- [\_type](../wiki/XUI.XUICoreObjects.XView#_type)
- [text](../wiki/XUI.XUICoreObjects.XView#text)

### Accessors

- [DOMElementFromHTML](../wiki/XUI.XUICoreObjects.XView#domelementfromhtml)

### Methods

- [append](../wiki/XUI.XUICoreObjects.XView#append)
- [attach](../wiki/XUI.XUICoreObjects.XView#attach)
- [execute](../wiki/XUI.XUICoreObjects.XView#execute)
- [getDOMObject](../wiki/XUI.XUICoreObjects.XView#getdomobject)
- [getHTML](../wiki/XUI.XUICoreObjects.XView#gethtml)
- [hide](../wiki/XUI.XUICoreObjects.XView#hide)
- [init](../wiki/XUI.XUICoreObjects.XView#init)
- [log](../wiki/XUI.XUICoreObjects.XView#log)
- [onCreate](../wiki/XUI.XUICoreObjects.XView#oncreate)
- [onFrame](../wiki/XUI.XUICoreObjects.XView#onframe)
- [onMount](../wiki/XUI.XUICoreObjects.XView#onmount)
- [parse](../wiki/XUI.XUICoreObjects.XView#parse)
- [setStyle](../wiki/XUI.XUICoreObjects.XView#setstyle)
- [setText](../wiki/XUI.XUICoreObjects.XView#settext)
- [show](../wiki/XUI.XUICoreObjects.XView#show)

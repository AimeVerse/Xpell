...
[XUI/XUICoreObjects](../wiki/XUI.XUICoreObjects).XHTML
...
- [constructor](../wiki/XUI.XUICoreObjects.XHTML#constructor)

### Properties

- [\_base\_display](../wiki/XUI.XUICoreObjects.XHTML#_base_display)
- [\_children](../wiki/XUI.XUICoreObjects.XHTML#_children)
- [\_data\_source](../wiki/XUI.XUICoreObjects.XHTML#_data_source)
- [\_format](../wiki/XUI.XUICoreObjects.XHTML#_format)
- [\_html](../wiki/XUI.XUICoreObjects.XHTML#_html)
- [\_html\_ns](../wiki/XUI.XUICoreObjects.XHTML#_html_ns)
- [\_html\_tag](../wiki/XUI.XUICoreObjects.XHTML#_html_tag)
- [\_ignore](../wiki/XUI.XUICoreObjects.XHTML#_ignore)
- [\_on\_frame\_skip\_data\_source](../wiki/XUI.XUICoreObjects.XHTML#_on_frame_skip_data_source)
- [\_type](../wiki/XUI.XUICoreObjects.XHTML#_type)
- [text](../wiki/XUI.XUICoreObjects.XHTML#text)

### Accessors

- [DOMElementFromHTML](../wiki/XUI.XUICoreObjects.XHTML#domelementfromhtml)

### Methods

- [append](../wiki/XUI.XUICoreObjects.XHTML#append)
- [attach](../wiki/XUI.XUICoreObjects.XHTML#attach)
- [execute](../wiki/XUI.XUICoreObjects.XHTML#execute)
- [getDOMObject](../wiki/XUI.XUICoreObjects.XHTML#getdomobject)
- [getHTML](../wiki/XUI.XUICoreObjects.XHTML#gethtml)
- [hide](../wiki/XUI.XUICoreObjects.XHTML#hide)
- [init](../wiki/XUI.XUICoreObjects.XHTML#init)
- [log](../wiki/XUI.XUICoreObjects.XHTML#log)
- [onCreate](../wiki/XUI.XUICoreObjects.XHTML#oncreate)
- [onFrame](../wiki/XUI.XUICoreObjects.XHTML#onframe)
- [onMount](../wiki/XUI.XUICoreObjects.XHTML#onmount)
- [parse](../wiki/XUI.XUICoreObjects.XHTML#parse)
- [setStyle](../wiki/XUI.XUICoreObjects.XHTML#setstyle)
- [setText](../wiki/XUI.XUICoreObjects.XHTML#settext)
- [show](../wiki/XUI.XUICoreObjects.XHTML#show)

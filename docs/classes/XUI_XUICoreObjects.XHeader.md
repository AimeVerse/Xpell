[xpell](../README.md) / [Modules](../modules.md) / [XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md) / XHeader

# Class: XHeader

[XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md).XHeader
...
- [constructor](XUI_XUICoreObjects.XHeader.md#constructor)

### Properties

- [#\_text](XUI_XUICoreObjects.XHeader.md##_text)
- [\_base\_display](XUI_XUICoreObjects.XHeader.md#_base_display)
- [\_cache\_cmd\_txt](XUI_XUICoreObjects.XHeader.md#_cache_cmd_txt)
- [\_cache\_jcmd](XUI_XUICoreObjects.XHeader.md#_cache_jcmd)
- [\_children](XUI_XUICoreObjects.XHeader.md#_children)
- [\_data\_source](XUI_XUICoreObjects.XHeader.md#_data_source)
- [\_dom\_object](XUI_XUICoreObjects.XHeader.md#_dom_object)
- [\_event\_listeners\_ids](XUI_XUICoreObjects.XHeader.md#_event_listeners_ids)
- [\_html](XUI_XUICoreObjects.XHeader.md#_html)
- [\_html\_ns](XUI_XUICoreObjects.XHeader.md#_html_ns)
- [\_html\_tag](XUI_XUICoreObjects.XHeader.md#_html_tag)
- [\_id](XUI_XUICoreObjects.XHeader.md#_id)
- [\_name](XUI_XUICoreObjects.XHeader.md#_name)
- [\_nano\_commands](XUI_XUICoreObjects.XHeader.md#_nano_commands)
- [\_on](XUI_XUICoreObjects.XHeader.md#_on)
- [\_on\_click](XUI_XUICoreObjects.XHeader.md#_on_click)
- [\_on\_create](XUI_XUICoreObjects.XHeader.md#_on_create)
- [\_on\_data](XUI_XUICoreObjects.XHeader.md#_on_data)
- [\_on\_event](XUI_XUICoreObjects.XHeader.md#_on_event)
- [\_on\_frame](XUI_XUICoreObjects.XHeader.md#_on_frame)
- [\_on\_hide](XUI_XUICoreObjects.XHeader.md#_on_hide)
- [\_on\_mount](XUI_XUICoreObjects.XHeader.md#_on_mount)
- [\_on\_show](XUI_XUICoreObjects.XHeader.md#_on_show)
- [\_once](XUI_XUICoreObjects.XHeader.md#_once)
- [\_parent](XUI_XUICoreObjects.XHeader.md#_parent)
- [\_parent\_element](XUI_XUICoreObjects.XHeader.md#_parent_element)
- [\_process\_data](XUI_XUICoreObjects.XHeader.md#_process_data)
- [\_process\_frame](XUI_XUICoreObjects.XHeader.md#_process_frame)
- [\_type](XUI_XUICoreObjects.XHeader.md#_type)
- [\_visible](XUI_XUICoreObjects.XHeader.md#_visible)
- [\_xem\_options](XUI_XUICoreObjects.XHeader.md#_xem_options)
- [\_xporter](XUI_XUICoreObjects.XHeader.md#_xporter)

### Accessors

- [\_text](XUI_XUICoreObjects.XHeader.md#_text)
- [dom](XUI_XUICoreObjects.XHeader.md#dom)

### Methods

- [addClass](XUI_XUICoreObjects.XHeader.md#addclass)
- [addEventListener](XUI_XUICoreObjects.XHeader.md#addeventlistener)
- [addNanoCommand](XUI_XUICoreObjects.XHeader.md#addnanocommand)
- [addNanoCommandPack](XUI_XUICoreObjects.XHeader.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XUI_XUICoreObjects.XHeader.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XUI_XUICoreObjects.XHeader.md#addxporterinstancexporter)
- [append](XUI_XUICoreObjects.XHeader.md#append)
- [attach](XUI_XUICoreObjects.XHeader.md#attach)
- [checkAndRunInternalFunction](XUI_XUICoreObjects.XHeader.md#checkandruninternalfunction)
- [clearAttributes](XUI_XUICoreObjects.XHeader.md#clearattributes)
- [click](XUI_XUICoreObjects.XHeader.md#click)
- [dispose](XUI_XUICoreObjects.XHeader.md#dispose)
- [emptyDataSource](XUI_XUICoreObjects.XHeader.md#emptydatasource)
- [execute](XUI_XUICoreObjects.XHeader.md#execute)
- [getDOMObject](XUI_XUICoreObjects.XHeader.md#getdomobject)
- [getHTML](XUI_XUICoreObjects.XHeader.md#gethtml)
- [hide](XUI_XUICoreObjects.XHeader.md#hide)
- [init](XUI_XUICoreObjects.XHeader.md#init)
- [log](XUI_XUICoreObjects.XHeader.md#log)
- [mount](XUI_XUICoreObjects.XHeader.md#mount)
- [onCreate](XUI_XUICoreObjects.XHeader.md#oncreate)
- [onData](XUI_XUICoreObjects.XHeader.md#ondata)
- [onFrame](XUI_XUICoreObjects.XHeader.md#onframe)
- [onHide](XUI_XUICoreObjects.XHeader.md#onhide)
- [onMount](XUI_XUICoreObjects.XHeader.md#onmount)
- [onShow](XUI_XUICoreObjects.XHeader.md#onshow)
- [parse](XUI_XUICoreObjects.XHeader.md#parse)
- [parseEvents](XUI_XUICoreObjects.XHeader.md#parseevents)
- [parseFields](XUI_XUICoreObjects.XHeader.md#parsefields)
- [parseFieldsFromXDataObject](XUI_XUICoreObjects.XHeader.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XUI_XUICoreObjects.XHeader.md#removealleventlisteners)
- [removeClass](XUI_XUICoreObjects.XHeader.md#removeclass)
- [removeEventListener](XUI_XUICoreObjects.XHeader.md#removeeventlistener)
- [replaceClass](XUI_XUICoreObjects.XHeader.md#replaceclass)
- [run](XUI_XUICoreObjects.XHeader.md#run)
- [setStyleAttribute](XUI_XUICoreObjects.XHeader.md#setstyleattribute)
- [setText](XUI_XUICoreObjects.XHeader.md#settext)
- [show](XUI_XUICoreObjects.XHeader.md#show)
- [toString](XUI_XUICoreObjects.XHeader.md#tostring)
- [toXData](XUI_XUICoreObjects.XHeader.md#toxdata)
- [toggle](XUI_XUICoreObjects.XHeader.md#toggle)
- [toggleClass](XUI_XUICoreObjects.XHeader.md#toggleclass)

## Constructors

### constructor

• **new XHeader**(`data`): [`XHeader`](XUI_XUICoreObjects.XHeader.md)

[xpell](../README.md) / [Modules](../modules.md) / [XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md) / XList

# Class: XList

[XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md).XList
...
- [constructor](XUI_XUICoreObjects.XList.md#constructor)

### Properties

- [#\_text](XUI_XUICoreObjects.XList.md##_text)
- [\_base\_display](XUI_XUICoreObjects.XList.md#_base_display)
- [\_cache\_cmd\_txt](XUI_XUICoreObjects.XList.md#_cache_cmd_txt)
- [\_cache\_jcmd](XUI_XUICoreObjects.XList.md#_cache_jcmd)
- [\_children](XUI_XUICoreObjects.XList.md#_children)
- [\_data\_source](XUI_XUICoreObjects.XList.md#_data_source)
- [\_dom\_object](XUI_XUICoreObjects.XList.md#_dom_object)
- [\_event\_listeners\_ids](XUI_XUICoreObjects.XList.md#_event_listeners_ids)
- [\_html](XUI_XUICoreObjects.XList.md#_html)
- [\_html\_ns](XUI_XUICoreObjects.XList.md#_html_ns)
- [\_html\_tag](XUI_XUICoreObjects.XList.md#_html_tag)
- [\_id](XUI_XUICoreObjects.XList.md#_id)
- [\_items](XUI_XUICoreObjects.XList.md#_items)
- [\_name](XUI_XUICoreObjects.XList.md#_name)
- [\_nano\_commands](XUI_XUICoreObjects.XList.md#_nano_commands)
- [\_on](XUI_XUICoreObjects.XList.md#_on)
- [\_on\_click](XUI_XUICoreObjects.XList.md#_on_click)
- [\_on\_create](XUI_XUICoreObjects.XList.md#_on_create)
- [\_on\_data](XUI_XUICoreObjects.XList.md#_on_data)
- [\_on\_event](XUI_XUICoreObjects.XList.md#_on_event)
- [\_on\_frame](XUI_XUICoreObjects.XList.md#_on_frame)
- [\_on\_hide](XUI_XUICoreObjects.XList.md#_on_hide)
- [\_on\_mount](XUI_XUICoreObjects.XList.md#_on_mount)
- [\_on\_show](XUI_XUICoreObjects.XList.md#_on_show)
- [\_once](XUI_XUICoreObjects.XList.md#_once)
- [\_parent](XUI_XUICoreObjects.XList.md#_parent)
- [\_parent\_element](XUI_XUICoreObjects.XList.md#_parent_element)
- [\_process\_data](XUI_XUICoreObjects.XList.md#_process_data)
- [\_process\_frame](XUI_XUICoreObjects.XList.md#_process_frame)
- [\_type](XUI_XUICoreObjects.XList.md#_type)
- [\_visible](XUI_XUICoreObjects.XList.md#_visible)
- [\_xem\_options](XUI_XUICoreObjects.XList.md#_xem_options)
- [\_xporter](XUI_XUICoreObjects.XList.md#_xporter)

### Accessors

- [\_text](XUI_XUICoreObjects.XList.md#_text)
- [dom](XUI_XUICoreObjects.XList.md#dom)

### Methods

- [addClass](XUI_XUICoreObjects.XList.md#addclass)
- [addEventListener](XUI_XUICoreObjects.XList.md#addeventlistener)
- [addNanoCommand](XUI_XUICoreObjects.XList.md#addnanocommand)
- [addNanoCommandPack](XUI_XUICoreObjects.XList.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XUI_XUICoreObjects.XList.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XUI_XUICoreObjects.XList.md#addxporterinstancexporter)
- [append](XUI_XUICoreObjects.XList.md#append)
- [attach](XUI_XUICoreObjects.XList.md#attach)
- [checkAndRunInternalFunction](XUI_XUICoreObjects.XList.md#checkandruninternalfunction)
- [clearAttributes](XUI_XUICoreObjects.XList.md#clearattributes)
- [click](XUI_XUICoreObjects.XList.md#click)
- [dispose](XUI_XUICoreObjects.XList.md#dispose)
- [emptyDataSource](XUI_XUICoreObjects.XList.md#emptydatasource)
- [execute](XUI_XUICoreObjects.XList.md#execute)
- [getDOMObject](XUI_XUICoreObjects.XList.md#getdomobject)
- [getHTML](XUI_XUICoreObjects.XList.md#gethtml)
- [hide](XUI_XUICoreObjects.XList.md#hide)
- [init](XUI_XUICoreObjects.XList.md#init)
- [log](XUI_XUICoreObjects.XList.md#log)
- [mount](XUI_XUICoreObjects.XList.md#mount)
- [onCreate](XUI_XUICoreObjects.XList.md#oncreate)
- [onData](XUI_XUICoreObjects.XList.md#ondata)
- [onFrame](XUI_XUICoreObjects.XList.md#onframe)
- [onHide](XUI_XUICoreObjects.XList.md#onhide)
- [onMount](XUI_XUICoreObjects.XList.md#onmount)
- [onShow](XUI_XUICoreObjects.XList.md#onshow)
- [parse](XUI_XUICoreObjects.XList.md#parse)
- [parseEvents](XUI_XUICoreObjects.XList.md#parseevents)
- [parseFields](XUI_XUICoreObjects.XList.md#parsefields)
- [parseFieldsFromXDataObject](XUI_XUICoreObjects.XList.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XUI_XUICoreObjects.XList.md#removealleventlisteners)
- [removeClass](XUI_XUICoreObjects.XList.md#removeclass)
- [removeEventListener](XUI_XUICoreObjects.XList.md#removeeventlistener)
- [replaceClass](XUI_XUICoreObjects.XList.md#replaceclass)
- [run](XUI_XUICoreObjects.XList.md#run)
- [setStyleAttribute](XUI_XUICoreObjects.XList.md#setstyleattribute)
- [setText](XUI_XUICoreObjects.XList.md#settext)
- [show](XUI_XUICoreObjects.XList.md#show)
- [toString](XUI_XUICoreObjects.XList.md#tostring)
- [toXData](XUI_XUICoreObjects.XList.md#toxdata)
- [toggle](XUI_XUICoreObjects.XList.md#toggle)
- [toggleClass](XUI_XUICoreObjects.XList.md#toggleclass)

## Constructors

### constructor

• **new XList**(`data`): [`XList`](XUI_XUICoreObjects.XList.md)

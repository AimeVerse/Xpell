[xpell](../README.md) / [Modules](../modules.md) / [XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md) / XNavBar

# Class: XNavBar

[XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md).XNavBar
...
- [constructor](XUI_XUICoreObjects.XNavBar.md#constructor)

### Properties

- [#\_text](XUI_XUICoreObjects.XNavBar.md##_text)
- [\_base\_display](XUI_XUICoreObjects.XNavBar.md#_base_display)
- [\_cache\_cmd\_txt](XUI_XUICoreObjects.XNavBar.md#_cache_cmd_txt)
- [\_cache\_jcmd](XUI_XUICoreObjects.XNavBar.md#_cache_jcmd)
- [\_children](XUI_XUICoreObjects.XNavBar.md#_children)
- [\_data\_source](XUI_XUICoreObjects.XNavBar.md#_data_source)
- [\_dom\_object](XUI_XUICoreObjects.XNavBar.md#_dom_object)
- [\_event\_listeners\_ids](XUI_XUICoreObjects.XNavBar.md#_event_listeners_ids)
- [\_html](XUI_XUICoreObjects.XNavBar.md#_html)
- [\_html\_ns](XUI_XUICoreObjects.XNavBar.md#_html_ns)
- [\_html\_tag](XUI_XUICoreObjects.XNavBar.md#_html_tag)
- [\_id](XUI_XUICoreObjects.XNavBar.md#_id)
- [\_name](XUI_XUICoreObjects.XNavBar.md#_name)
- [\_nano\_commands](XUI_XUICoreObjects.XNavBar.md#_nano_commands)
- [\_on](XUI_XUICoreObjects.XNavBar.md#_on)
- [\_on\_click](XUI_XUICoreObjects.XNavBar.md#_on_click)
- [\_on\_create](XUI_XUICoreObjects.XNavBar.md#_on_create)
- [\_on\_data](XUI_XUICoreObjects.XNavBar.md#_on_data)
- [\_on\_event](XUI_XUICoreObjects.XNavBar.md#_on_event)
- [\_on\_frame](XUI_XUICoreObjects.XNavBar.md#_on_frame)
- [\_on\_hide](XUI_XUICoreObjects.XNavBar.md#_on_hide)
- [\_on\_mount](XUI_XUICoreObjects.XNavBar.md#_on_mount)
- [\_on\_show](XUI_XUICoreObjects.XNavBar.md#_on_show)
- [\_once](XUI_XUICoreObjects.XNavBar.md#_once)
- [\_parent](XUI_XUICoreObjects.XNavBar.md#_parent)
- [\_parent\_element](XUI_XUICoreObjects.XNavBar.md#_parent_element)
- [\_process\_data](XUI_XUICoreObjects.XNavBar.md#_process_data)
- [\_process\_frame](XUI_XUICoreObjects.XNavBar.md#_process_frame)
- [\_type](XUI_XUICoreObjects.XNavBar.md#_type)
- [\_visible](XUI_XUICoreObjects.XNavBar.md#_visible)
- [\_xem\_options](XUI_XUICoreObjects.XNavBar.md#_xem_options)
- [\_xporter](XUI_XUICoreObjects.XNavBar.md#_xporter)

### Accessors

- [\_text](XUI_XUICoreObjects.XNavBar.md#_text)
- [dom](XUI_XUICoreObjects.XNavBar.md#dom)

### Methods

- [addClass](XUI_XUICoreObjects.XNavBar.md#addclass)
- [addEventListener](XUI_XUICoreObjects.XNavBar.md#addeventlistener)
- [addNanoCommand](XUI_XUICoreObjects.XNavBar.md#addnanocommand)
- [addNanoCommandPack](XUI_XUICoreObjects.XNavBar.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XUI_XUICoreObjects.XNavBar.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XUI_XUICoreObjects.XNavBar.md#addxporterinstancexporter)
- [append](XUI_XUICoreObjects.XNavBar.md#append)
- [attach](XUI_XUICoreObjects.XNavBar.md#attach)
- [checkAndRunInternalFunction](XUI_XUICoreObjects.XNavBar.md#checkandruninternalfunction)
- [clearAttributes](XUI_XUICoreObjects.XNavBar.md#clearattributes)
- [click](XUI_XUICoreObjects.XNavBar.md#click)
- [dispose](XUI_XUICoreObjects.XNavBar.md#dispose)
- [emptyDataSource](XUI_XUICoreObjects.XNavBar.md#emptydatasource)
- [execute](XUI_XUICoreObjects.XNavBar.md#execute)
- [getDOMObject](XUI_XUICoreObjects.XNavBar.md#getdomobject)
- [getHTML](XUI_XUICoreObjects.XNavBar.md#gethtml)
- [hide](XUI_XUICoreObjects.XNavBar.md#hide)
- [init](XUI_XUICoreObjects.XNavBar.md#init)
- [log](XUI_XUICoreObjects.XNavBar.md#log)
- [mount](XUI_XUICoreObjects.XNavBar.md#mount)
- [onCreate](XUI_XUICoreObjects.XNavBar.md#oncreate)
- [onData](XUI_XUICoreObjects.XNavBar.md#ondata)
- [onFrame](XUI_XUICoreObjects.XNavBar.md#onframe)
- [onHide](XUI_XUICoreObjects.XNavBar.md#onhide)
- [onMount](XUI_XUICoreObjects.XNavBar.md#onmount)
- [onShow](XUI_XUICoreObjects.XNavBar.md#onshow)
- [parse](XUI_XUICoreObjects.XNavBar.md#parse)
- [parseEvents](XUI_XUICoreObjects.XNavBar.md#parseevents)
- [parseFields](XUI_XUICoreObjects.XNavBar.md#parsefields)
- [parseFieldsFromXDataObject](XUI_XUICoreObjects.XNavBar.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XUI_XUICoreObjects.XNavBar.md#removealleventlisteners)
- [removeClass](XUI_XUICoreObjects.XNavBar.md#removeclass)
- [removeEventListener](XUI_XUICoreObjects.XNavBar.md#removeeventlistener)
- [replaceClass](XUI_XUICoreObjects.XNavBar.md#replaceclass)
- [run](XUI_XUICoreObjects.XNavBar.md#run)
- [setStyleAttribute](XUI_XUICoreObjects.XNavBar.md#setstyleattribute)
- [setText](XUI_XUICoreObjects.XNavBar.md#settext)
- [show](XUI_XUICoreObjects.XNavBar.md#show)
- [toString](XUI_XUICoreObjects.XNavBar.md#tostring)
- [toXData](XUI_XUICoreObjects.XNavBar.md#toxdata)
- [toggle](XUI_XUICoreObjects.XNavBar.md#toggle)
- [toggleClass](XUI_XUICoreObjects.XNavBar.md#toggleclass)

## Constructors

### constructor

• **new XNavBar**(`data`): [`XNavBar`](XUI_XUICoreObjects.XNavBar.md)

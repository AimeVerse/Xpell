[xpell](../README.md) / [Modules](../modules.md) / [XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md) / XWebcam

# Class: XWebcam

[XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md).XWebcam
...
- [constructor](XUI_XUICoreObjects.XWebcam.md#constructor)

### Properties

- [#\_text](XUI_XUICoreObjects.XWebcam.md##_text)
- [\_base\_display](XUI_XUICoreObjects.XWebcam.md#_base_display)
- [\_cache\_cmd\_txt](XUI_XUICoreObjects.XWebcam.md#_cache_cmd_txt)
- [\_cache\_jcmd](XUI_XUICoreObjects.XWebcam.md#_cache_jcmd)
- [\_children](XUI_XUICoreObjects.XWebcam.md#_children)
- [\_data\_source](XUI_XUICoreObjects.XWebcam.md#_data_source)
- [\_dom\_object](XUI_XUICoreObjects.XWebcam.md#_dom_object)
- [\_event\_listeners\_ids](XUI_XUICoreObjects.XWebcam.md#_event_listeners_ids)
- [\_html](XUI_XUICoreObjects.XWebcam.md#_html)
- [\_html\_ns](XUI_XUICoreObjects.XWebcam.md#_html_ns)
- [\_html\_tag](XUI_XUICoreObjects.XWebcam.md#_html_tag)
- [\_id](XUI_XUICoreObjects.XWebcam.md#_id)
- [\_name](XUI_XUICoreObjects.XWebcam.md#_name)
- [\_nano\_commands](XUI_XUICoreObjects.XWebcam.md#_nano_commands)
- [\_on](XUI_XUICoreObjects.XWebcam.md#_on)
- [\_on\_click](XUI_XUICoreObjects.XWebcam.md#_on_click)
- [\_on\_create](XUI_XUICoreObjects.XWebcam.md#_on_create)
- [\_on\_data](XUI_XUICoreObjects.XWebcam.md#_on_data)
- [\_on\_event](XUI_XUICoreObjects.XWebcam.md#_on_event)
- [\_on\_frame](XUI_XUICoreObjects.XWebcam.md#_on_frame)
- [\_on\_hide](XUI_XUICoreObjects.XWebcam.md#_on_hide)
- [\_on\_mount](XUI_XUICoreObjects.XWebcam.md#_on_mount)
- [\_on\_show](XUI_XUICoreObjects.XWebcam.md#_on_show)
- [\_once](XUI_XUICoreObjects.XWebcam.md#_once)
- [\_parent](XUI_XUICoreObjects.XWebcam.md#_parent)
- [\_parent\_element](XUI_XUICoreObjects.XWebcam.md#_parent_element)
- [\_process\_data](XUI_XUICoreObjects.XWebcam.md#_process_data)
- [\_process\_frame](XUI_XUICoreObjects.XWebcam.md#_process_frame)
- [\_type](XUI_XUICoreObjects.XWebcam.md#_type)
- [\_video\_constraints](XUI_XUICoreObjects.XWebcam.md#_video_constraints)
- [\_visible](XUI_XUICoreObjects.XWebcam.md#_visible)
- [\_xem\_options](XUI_XUICoreObjects.XWebcam.md#_xem_options)
- [\_xporter](XUI_XUICoreObjects.XWebcam.md#_xporter)
- [autoplay](XUI_XUICoreObjects.XWebcam.md#autoplay)
- [muted](XUI_XUICoreObjects.XWebcam.md#muted)

### Accessors

- [\_text](XUI_XUICoreObjects.XWebcam.md#_text)
- [dom](XUI_XUICoreObjects.XWebcam.md#dom)
- [isPlaying](XUI_XUICoreObjects.XWebcam.md#isplaying)

### Methods

- [addClass](XUI_XUICoreObjects.XWebcam.md#addclass)
- [addEventListener](XUI_XUICoreObjects.XWebcam.md#addeventlistener)
- [addNanoCommand](XUI_XUICoreObjects.XWebcam.md#addnanocommand)
- [addNanoCommandPack](XUI_XUICoreObjects.XWebcam.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XUI_XUICoreObjects.XWebcam.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XUI_XUICoreObjects.XWebcam.md#addxporterinstancexporter)
- [append](XUI_XUICoreObjects.XWebcam.md#append)
- [attach](XUI_XUICoreObjects.XWebcam.md#attach)
- [checkAndRunInternalFunction](XUI_XUICoreObjects.XWebcam.md#checkandruninternalfunction)
- [clearAttributes](XUI_XUICoreObjects.XWebcam.md#clearattributes)
- [click](XUI_XUICoreObjects.XWebcam.md#click)
- [dispose](XUI_XUICoreObjects.XWebcam.md#dispose)
- [emptyDataSource](XUI_XUICoreObjects.XWebcam.md#emptydatasource)
- [execute](XUI_XUICoreObjects.XWebcam.md#execute)
- [getDOMObject](XUI_XUICoreObjects.XWebcam.md#getdomobject)
- [getHTML](XUI_XUICoreObjects.XWebcam.md#gethtml)
- [hide](XUI_XUICoreObjects.XWebcam.md#hide)
- [init](XUI_XUICoreObjects.XWebcam.md#init)
- [isAvailable](XUI_XUICoreObjects.XWebcam.md#isavailable)
- [log](XUI_XUICoreObjects.XWebcam.md#log)
- [mount](XUI_XUICoreObjects.XWebcam.md#mount)
- [onCreate](XUI_XUICoreObjects.XWebcam.md#oncreate)
- [onData](XUI_XUICoreObjects.XWebcam.md#ondata)
- [onFrame](XUI_XUICoreObjects.XWebcam.md#onframe)
- [onHide](XUI_XUICoreObjects.XWebcam.md#onhide)
- [onMount](XUI_XUICoreObjects.XWebcam.md#onmount)
- [onShow](XUI_XUICoreObjects.XWebcam.md#onshow)
- [parse](XUI_XUICoreObjects.XWebcam.md#parse)
- [parseEvents](XUI_XUICoreObjects.XWebcam.md#parseevents)
- [parseFields](XUI_XUICoreObjects.XWebcam.md#parsefields)
- [parseFieldsFromXDataObject](XUI_XUICoreObjects.XWebcam.md#parsefieldsfromxdataobject)
- [pause](XUI_XUICoreObjects.XWebcam.md#pause)
- [removeAllEventListeners](XUI_XUICoreObjects.XWebcam.md#removealleventlisteners)
- [removeClass](XUI_XUICoreObjects.XWebcam.md#removeclass)
- [removeEventListener](XUI_XUICoreObjects.XWebcam.md#removeeventlistener)
- [replaceClass](XUI_XUICoreObjects.XWebcam.md#replaceclass)
- [run](XUI_XUICoreObjects.XWebcam.md#run)
- [setSource](XUI_XUICoreObjects.XWebcam.md#setsource)
- [setStyleAttribute](XUI_XUICoreObjects.XWebcam.md#setstyleattribute)
- [setText](XUI_XUICoreObjects.XWebcam.md#settext)
- [show](XUI_XUICoreObjects.XWebcam.md#show)
- [toString](XUI_XUICoreObjects.XWebcam.md#tostring)
- [toXData](XUI_XUICoreObjects.XWebcam.md#toxdata)
- [toggle](XUI_XUICoreObjects.XWebcam.md#toggle)
- [toggleClass](XUI_XUICoreObjects.XWebcam.md#toggleclass)

## Constructors

### constructor

• **new XWebcam**(`data`): [`XWebcam`](XUI_XUICoreObjects.XWebcam.md)

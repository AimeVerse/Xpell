[xpell](../README.md) / [Modules](../modules.md) / [XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md) / XSVG

# Class: XSVG

[XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md).XSVG
...
- [constructor](XUI_XUICoreObjects.XSVG.md#constructor)

### Properties

- [#\_text](XUI_XUICoreObjects.XSVG.md##_text)
- [\_base\_display](XUI_XUICoreObjects.XSVG.md#_base_display)
- [\_cache\_cmd\_txt](XUI_XUICoreObjects.XSVG.md#_cache_cmd_txt)
- [\_cache\_jcmd](XUI_XUICoreObjects.XSVG.md#_cache_jcmd)
- [\_children](XUI_XUICoreObjects.XSVG.md#_children)
- [\_data\_source](XUI_XUICoreObjects.XSVG.md#_data_source)
- [\_dom\_object](XUI_XUICoreObjects.XSVG.md#_dom_object)
- [\_event\_listeners\_ids](XUI_XUICoreObjects.XSVG.md#_event_listeners_ids)
- [\_html](XUI_XUICoreObjects.XSVG.md#_html)
- [\_html\_ns](XUI_XUICoreObjects.XSVG.md#_html_ns)
- [\_html\_tag](XUI_XUICoreObjects.XSVG.md#_html_tag)
- [\_id](XUI_XUICoreObjects.XSVG.md#_id)
- [\_name](XUI_XUICoreObjects.XSVG.md#_name)
- [\_nano\_commands](XUI_XUICoreObjects.XSVG.md#_nano_commands)
- [\_on](XUI_XUICoreObjects.XSVG.md#_on)
- [\_on\_click](XUI_XUICoreObjects.XSVG.md#_on_click)
- [\_on\_create](XUI_XUICoreObjects.XSVG.md#_on_create)
- [\_on\_data](XUI_XUICoreObjects.XSVG.md#_on_data)
- [\_on\_event](XUI_XUICoreObjects.XSVG.md#_on_event)
- [\_on\_frame](XUI_XUICoreObjects.XSVG.md#_on_frame)
- [\_on\_hide](XUI_XUICoreObjects.XSVG.md#_on_hide)
- [\_on\_mount](XUI_XUICoreObjects.XSVG.md#_on_mount)
- [\_on\_show](XUI_XUICoreObjects.XSVG.md#_on_show)
- [\_once](XUI_XUICoreObjects.XSVG.md#_once)
- [\_parent](XUI_XUICoreObjects.XSVG.md#_parent)
- [\_parent\_element](XUI_XUICoreObjects.XSVG.md#_parent_element)
- [\_process\_data](XUI_XUICoreObjects.XSVG.md#_process_data)
- [\_process\_frame](XUI_XUICoreObjects.XSVG.md#_process_frame)
- [\_svg\_data](XUI_XUICoreObjects.XSVG.md#_svg_data)
- [\_type](XUI_XUICoreObjects.XSVG.md#_type)
- [\_visible](XUI_XUICoreObjects.XSVG.md#_visible)
- [\_xem\_options](XUI_XUICoreObjects.XSVG.md#_xem_options)
- [\_xporter](XUI_XUICoreObjects.XSVG.md#_xporter)

### Accessors

- [\_text](XUI_XUICoreObjects.XSVG.md#_text)
- [dom](XUI_XUICoreObjects.XSVG.md#dom)

### Methods

- [addClass](XUI_XUICoreObjects.XSVG.md#addclass)
- [addEventListener](XUI_XUICoreObjects.XSVG.md#addeventlistener)
- [addNanoCommand](XUI_XUICoreObjects.XSVG.md#addnanocommand)
- [addNanoCommandPack](XUI_XUICoreObjects.XSVG.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XUI_XUICoreObjects.XSVG.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XUI_XUICoreObjects.XSVG.md#addxporterinstancexporter)
- [append](XUI_XUICoreObjects.XSVG.md#append)
- [attach](XUI_XUICoreObjects.XSVG.md#attach)
- [checkAndRunInternalFunction](XUI_XUICoreObjects.XSVG.md#checkandruninternalfunction)
- [clearAttributes](XUI_XUICoreObjects.XSVG.md#clearattributes)
- [click](XUI_XUICoreObjects.XSVG.md#click)
- [dispose](XUI_XUICoreObjects.XSVG.md#dispose)
- [emptyDataSource](XUI_XUICoreObjects.XSVG.md#emptydatasource)
- [execute](XUI_XUICoreObjects.XSVG.md#execute)
- [getDOMObject](XUI_XUICoreObjects.XSVG.md#getdomobject)
- [getHTML](XUI_XUICoreObjects.XSVG.md#gethtml)
- [hide](XUI_XUICoreObjects.XSVG.md#hide)
- [init](XUI_XUICoreObjects.XSVG.md#init)
- [log](XUI_XUICoreObjects.XSVG.md#log)
- [mount](XUI_XUICoreObjects.XSVG.md#mount)
- [onCreate](XUI_XUICoreObjects.XSVG.md#oncreate)
- [onData](XUI_XUICoreObjects.XSVG.md#ondata)
- [onFrame](XUI_XUICoreObjects.XSVG.md#onframe)
- [onHide](XUI_XUICoreObjects.XSVG.md#onhide)
- [onMount](XUI_XUICoreObjects.XSVG.md#onmount)
- [onShow](XUI_XUICoreObjects.XSVG.md#onshow)
- [parse](XUI_XUICoreObjects.XSVG.md#parse)
- [parseEvents](XUI_XUICoreObjects.XSVG.md#parseevents)
- [parseFields](XUI_XUICoreObjects.XSVG.md#parsefields)
- [parseFieldsFromXDataObject](XUI_XUICoreObjects.XSVG.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XUI_XUICoreObjects.XSVG.md#removealleventlisteners)
- [removeClass](XUI_XUICoreObjects.XSVG.md#removeclass)
- [removeEventListener](XUI_XUICoreObjects.XSVG.md#removeeventlistener)
- [replaceClass](XUI_XUICoreObjects.XSVG.md#replaceclass)
- [run](XUI_XUICoreObjects.XSVG.md#run)
- [setStyleAttribute](XUI_XUICoreObjects.XSVG.md#setstyleattribute)
- [setText](XUI_XUICoreObjects.XSVG.md#settext)
- [show](XUI_XUICoreObjects.XSVG.md#show)
- [toString](XUI_XUICoreObjects.XSVG.md#tostring)
- [toXData](XUI_XUICoreObjects.XSVG.md#toxdata)
- [toggle](XUI_XUICoreObjects.XSVG.md#toggle)
- [toggleClass](XUI_XUICoreObjects.XSVG.md#toggleclass)

## Constructors

### constructor

• **new XSVG**(`data`): [`XSVG`](XUI_XUICoreObjects.XSVG.md)

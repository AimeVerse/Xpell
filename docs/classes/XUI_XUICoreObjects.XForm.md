[xpell](../README.md) / [Modules](../modules.md) / [XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md) / XForm

# Class: XForm

[XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md).XForm
...
- [constructor](XUI_XUICoreObjects.XForm.md#constructor)

### Properties

- [#\_text](XUI_XUICoreObjects.XForm.md##_text)
- [\_base\_display](XUI_XUICoreObjects.XForm.md#_base_display)
- [\_cache\_cmd\_txt](XUI_XUICoreObjects.XForm.md#_cache_cmd_txt)
- [\_cache\_jcmd](XUI_XUICoreObjects.XForm.md#_cache_jcmd)
- [\_children](XUI_XUICoreObjects.XForm.md#_children)
- [\_data\_source](XUI_XUICoreObjects.XForm.md#_data_source)
- [\_dom\_object](XUI_XUICoreObjects.XForm.md#_dom_object)
- [\_event\_listeners\_ids](XUI_XUICoreObjects.XForm.md#_event_listeners_ids)
- [\_html](XUI_XUICoreObjects.XForm.md#_html)
- [\_html\_ns](XUI_XUICoreObjects.XForm.md#_html_ns)
- [\_html\_tag](XUI_XUICoreObjects.XForm.md#_html_tag)
- [\_id](XUI_XUICoreObjects.XForm.md#_id)
- [\_name](XUI_XUICoreObjects.XForm.md#_name)
- [\_nano\_commands](XUI_XUICoreObjects.XForm.md#_nano_commands)
- [\_on](XUI_XUICoreObjects.XForm.md#_on)
- [\_on\_click](XUI_XUICoreObjects.XForm.md#_on_click)
- [\_on\_create](XUI_XUICoreObjects.XForm.md#_on_create)
- [\_on\_data](XUI_XUICoreObjects.XForm.md#_on_data)
- [\_on\_event](XUI_XUICoreObjects.XForm.md#_on_event)
- [\_on\_frame](XUI_XUICoreObjects.XForm.md#_on_frame)
- [\_on\_hide](XUI_XUICoreObjects.XForm.md#_on_hide)
- [\_on\_mount](XUI_XUICoreObjects.XForm.md#_on_mount)
- [\_on\_show](XUI_XUICoreObjects.XForm.md#_on_show)
- [\_once](XUI_XUICoreObjects.XForm.md#_once)
- [\_parent](XUI_XUICoreObjects.XForm.md#_parent)
- [\_parent\_element](XUI_XUICoreObjects.XForm.md#_parent_element)
- [\_process\_data](XUI_XUICoreObjects.XForm.md#_process_data)
- [\_process\_frame](XUI_XUICoreObjects.XForm.md#_process_frame)
- [\_type](XUI_XUICoreObjects.XForm.md#_type)
- [\_visible](XUI_XUICoreObjects.XForm.md#_visible)
- [\_xem\_options](XUI_XUICoreObjects.XForm.md#_xem_options)
- [\_xporter](XUI_XUICoreObjects.XForm.md#_xporter)

### Accessors

- [\_text](XUI_XUICoreObjects.XForm.md#_text)
- [dom](XUI_XUICoreObjects.XForm.md#dom)

### Methods

- [addClass](XUI_XUICoreObjects.XForm.md#addclass)
- [addEventListener](XUI_XUICoreObjects.XForm.md#addeventlistener)
- [addNanoCommand](XUI_XUICoreObjects.XForm.md#addnanocommand)
- [addNanoCommandPack](XUI_XUICoreObjects.XForm.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XUI_XUICoreObjects.XForm.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XUI_XUICoreObjects.XForm.md#addxporterinstancexporter)
- [append](XUI_XUICoreObjects.XForm.md#append)
- [attach](XUI_XUICoreObjects.XForm.md#attach)
- [checkAndRunInternalFunction](XUI_XUICoreObjects.XForm.md#checkandruninternalfunction)
- [clearAttributes](XUI_XUICoreObjects.XForm.md#clearattributes)
- [click](XUI_XUICoreObjects.XForm.md#click)
- [dispose](XUI_XUICoreObjects.XForm.md#dispose)
- [emptyDataSource](XUI_XUICoreObjects.XForm.md#emptydatasource)
- [execute](XUI_XUICoreObjects.XForm.md#execute)
- [getDOMObject](XUI_XUICoreObjects.XForm.md#getdomobject)
- [getHTML](XUI_XUICoreObjects.XForm.md#gethtml)
- [hide](XUI_XUICoreObjects.XForm.md#hide)
- [init](XUI_XUICoreObjects.XForm.md#init)
- [log](XUI_XUICoreObjects.XForm.md#log)
- [mount](XUI_XUICoreObjects.XForm.md#mount)
- [onCreate](XUI_XUICoreObjects.XForm.md#oncreate)
- [onData](XUI_XUICoreObjects.XForm.md#ondata)
- [onFrame](XUI_XUICoreObjects.XForm.md#onframe)
- [onHide](XUI_XUICoreObjects.XForm.md#onhide)
- [onMount](XUI_XUICoreObjects.XForm.md#onmount)
- [onShow](XUI_XUICoreObjects.XForm.md#onshow)
- [parse](XUI_XUICoreObjects.XForm.md#parse)
- [parseEvents](XUI_XUICoreObjects.XForm.md#parseevents)
- [parseFields](XUI_XUICoreObjects.XForm.md#parsefields)
- [parseFieldsFromXDataObject](XUI_XUICoreObjects.XForm.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XUI_XUICoreObjects.XForm.md#removealleventlisteners)
- [removeClass](XUI_XUICoreObjects.XForm.md#removeclass)
- [removeEventListener](XUI_XUICoreObjects.XForm.md#removeeventlistener)
- [replaceClass](XUI_XUICoreObjects.XForm.md#replaceclass)
- [run](XUI_XUICoreObjects.XForm.md#run)
- [setStyleAttribute](XUI_XUICoreObjects.XForm.md#setstyleattribute)
- [setText](XUI_XUICoreObjects.XForm.md#settext)
- [show](XUI_XUICoreObjects.XForm.md#show)
- [toString](XUI_XUICoreObjects.XForm.md#tostring)
- [toXData](XUI_XUICoreObjects.XForm.md#toxdata)
- [toggle](XUI_XUICoreObjects.XForm.md#toggle)
- [toggleClass](XUI_XUICoreObjects.XForm.md#toggleclass)

## Constructors

### constructor

• **new XForm**(`data`): [`XForm`](XUI_XUICoreObjects.XForm.md)

[xpell](../README.md) / [Modules](../modules.md) / [XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md) / XHTML

# Class: XHTML

[XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md).XHTML
...
- [constructor](XUI_XUICoreObjects.XHTML.md#constructor)

### Properties

- [#\_text](XUI_XUICoreObjects.XHTML.md##_text)
- [\_base\_display](XUI_XUICoreObjects.XHTML.md#_base_display)
- [\_cache\_cmd\_txt](XUI_XUICoreObjects.XHTML.md#_cache_cmd_txt)
- [\_cache\_jcmd](XUI_XUICoreObjects.XHTML.md#_cache_jcmd)
- [\_children](XUI_XUICoreObjects.XHTML.md#_children)
- [\_data\_source](XUI_XUICoreObjects.XHTML.md#_data_source)
- [\_dom\_object](XUI_XUICoreObjects.XHTML.md#_dom_object)
- [\_event\_listeners\_ids](XUI_XUICoreObjects.XHTML.md#_event_listeners_ids)
- [\_html](XUI_XUICoreObjects.XHTML.md#_html)
- [\_html\_ns](XUI_XUICoreObjects.XHTML.md#_html_ns)
- [\_html\_tag](XUI_XUICoreObjects.XHTML.md#_html_tag)
- [\_id](XUI_XUICoreObjects.XHTML.md#_id)
- [\_name](XUI_XUICoreObjects.XHTML.md#_name)
- [\_nano\_commands](XUI_XUICoreObjects.XHTML.md#_nano_commands)
- [\_on](XUI_XUICoreObjects.XHTML.md#_on)
- [\_on\_click](XUI_XUICoreObjects.XHTML.md#_on_click)
- [\_on\_create](XUI_XUICoreObjects.XHTML.md#_on_create)
- [\_on\_data](XUI_XUICoreObjects.XHTML.md#_on_data)
- [\_on\_event](XUI_XUICoreObjects.XHTML.md#_on_event)
- [\_on\_frame](XUI_XUICoreObjects.XHTML.md#_on_frame)
- [\_on\_hide](XUI_XUICoreObjects.XHTML.md#_on_hide)
- [\_on\_mount](XUI_XUICoreObjects.XHTML.md#_on_mount)
- [\_on\_show](XUI_XUICoreObjects.XHTML.md#_on_show)
- [\_once](XUI_XUICoreObjects.XHTML.md#_once)
- [\_parent](XUI_XUICoreObjects.XHTML.md#_parent)
- [\_parent\_element](XUI_XUICoreObjects.XHTML.md#_parent_element)
- [\_process\_data](XUI_XUICoreObjects.XHTML.md#_process_data)
- [\_process\_frame](XUI_XUICoreObjects.XHTML.md#_process_frame)
- [\_type](XUI_XUICoreObjects.XHTML.md#_type)
- [\_visible](XUI_XUICoreObjects.XHTML.md#_visible)
- [\_xem\_options](XUI_XUICoreObjects.XHTML.md#_xem_options)
- [\_xporter](XUI_XUICoreObjects.XHTML.md#_xporter)

### Accessors

- [\_text](XUI_XUICoreObjects.XHTML.md#_text)
- [dom](XUI_XUICoreObjects.XHTML.md#dom)

### Methods

- [addClass](XUI_XUICoreObjects.XHTML.md#addclass)
- [addEventListener](XUI_XUICoreObjects.XHTML.md#addeventlistener)
- [addNanoCommand](XUI_XUICoreObjects.XHTML.md#addnanocommand)
- [addNanoCommandPack](XUI_XUICoreObjects.XHTML.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XUI_XUICoreObjects.XHTML.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XUI_XUICoreObjects.XHTML.md#addxporterinstancexporter)
- [append](XUI_XUICoreObjects.XHTML.md#append)
- [attach](XUI_XUICoreObjects.XHTML.md#attach)
- [checkAndRunInternalFunction](XUI_XUICoreObjects.XHTML.md#checkandruninternalfunction)
- [clearAttributes](XUI_XUICoreObjects.XHTML.md#clearattributes)
- [click](XUI_XUICoreObjects.XHTML.md#click)
- [dispose](XUI_XUICoreObjects.XHTML.md#dispose)
- [emptyDataSource](XUI_XUICoreObjects.XHTML.md#emptydatasource)
- [execute](XUI_XUICoreObjects.XHTML.md#execute)
- [getDOMObject](XUI_XUICoreObjects.XHTML.md#getdomobject)
- [getHTML](XUI_XUICoreObjects.XHTML.md#gethtml)
- [hide](XUI_XUICoreObjects.XHTML.md#hide)
- [init](XUI_XUICoreObjects.XHTML.md#init)
- [log](XUI_XUICoreObjects.XHTML.md#log)
- [mount](XUI_XUICoreObjects.XHTML.md#mount)
- [onCreate](XUI_XUICoreObjects.XHTML.md#oncreate)
- [onData](XUI_XUICoreObjects.XHTML.md#ondata)
- [onFrame](XUI_XUICoreObjects.XHTML.md#onframe)
- [onHide](XUI_XUICoreObjects.XHTML.md#onhide)
- [onMount](XUI_XUICoreObjects.XHTML.md#onmount)
- [onShow](XUI_XUICoreObjects.XHTML.md#onshow)
- [parse](XUI_XUICoreObjects.XHTML.md#parse)
- [parseEvents](XUI_XUICoreObjects.XHTML.md#parseevents)
- [parseFields](XUI_XUICoreObjects.XHTML.md#parsefields)
- [parseFieldsFromXDataObject](XUI_XUICoreObjects.XHTML.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XUI_XUICoreObjects.XHTML.md#removealleventlisteners)
- [removeClass](XUI_XUICoreObjects.XHTML.md#removeclass)
- [removeEventListener](XUI_XUICoreObjects.XHTML.md#removeeventlistener)
- [replaceClass](XUI_XUICoreObjects.XHTML.md#replaceclass)
- [run](XUI_XUICoreObjects.XHTML.md#run)
- [setStyleAttribute](XUI_XUICoreObjects.XHTML.md#setstyleattribute)
- [setText](XUI_XUICoreObjects.XHTML.md#settext)
- [show](XUI_XUICoreObjects.XHTML.md#show)
- [toString](XUI_XUICoreObjects.XHTML.md#tostring)
- [toXData](XUI_XUICoreObjects.XHTML.md#toxdata)
- [toggle](XUI_XUICoreObjects.XHTML.md#toggle)
- [toggleClass](XUI_XUICoreObjects.XHTML.md#toggleclass)

## Constructors

### constructor

• **new XHTML**(`data`): [`XHTML`](XUI_XUICoreObjects.XHTML.md)

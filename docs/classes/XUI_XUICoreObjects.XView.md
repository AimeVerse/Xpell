[xpell](../README.md) / [Modules](../modules.md) / [XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md) / XView

# Class: XView

[XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md).XView
...
- [constructor](XUI_XUICoreObjects.XView.md#constructor)

### Properties

- [#\_text](XUI_XUICoreObjects.XView.md##_text)
- [\_base\_display](XUI_XUICoreObjects.XView.md#_base_display)
- [\_cache\_cmd\_txt](XUI_XUICoreObjects.XView.md#_cache_cmd_txt)
- [\_cache\_jcmd](XUI_XUICoreObjects.XView.md#_cache_jcmd)
- [\_children](XUI_XUICoreObjects.XView.md#_children)
- [\_data\_source](XUI_XUICoreObjects.XView.md#_data_source)
- [\_dom\_object](XUI_XUICoreObjects.XView.md#_dom_object)
- [\_event\_listeners\_ids](XUI_XUICoreObjects.XView.md#_event_listeners_ids)
- [\_html](XUI_XUICoreObjects.XView.md#_html)
- [\_html\_ns](XUI_XUICoreObjects.XView.md#_html_ns)
- [\_html\_tag](XUI_XUICoreObjects.XView.md#_html_tag)
- [\_id](XUI_XUICoreObjects.XView.md#_id)
- [\_name](XUI_XUICoreObjects.XView.md#_name)
- [\_nano\_commands](XUI_XUICoreObjects.XView.md#_nano_commands)
- [\_on](XUI_XUICoreObjects.XView.md#_on)
- [\_on\_click](XUI_XUICoreObjects.XView.md#_on_click)
- [\_on\_create](XUI_XUICoreObjects.XView.md#_on_create)
- [\_on\_data](XUI_XUICoreObjects.XView.md#_on_data)
- [\_on\_event](XUI_XUICoreObjects.XView.md#_on_event)
- [\_on\_frame](XUI_XUICoreObjects.XView.md#_on_frame)
- [\_on\_hide](XUI_XUICoreObjects.XView.md#_on_hide)
- [\_on\_mount](XUI_XUICoreObjects.XView.md#_on_mount)
- [\_on\_show](XUI_XUICoreObjects.XView.md#_on_show)
- [\_once](XUI_XUICoreObjects.XView.md#_once)
- [\_parent](XUI_XUICoreObjects.XView.md#_parent)
- [\_parent\_element](XUI_XUICoreObjects.XView.md#_parent_element)
- [\_process\_data](XUI_XUICoreObjects.XView.md#_process_data)
- [\_process\_frame](XUI_XUICoreObjects.XView.md#_process_frame)
- [\_type](XUI_XUICoreObjects.XView.md#_type)
- [\_visible](XUI_XUICoreObjects.XView.md#_visible)
- [\_xem\_options](XUI_XUICoreObjects.XView.md#_xem_options)
- [\_xporter](XUI_XUICoreObjects.XView.md#_xporter)

### Accessors

- [\_text](XUI_XUICoreObjects.XView.md#_text)
- [dom](XUI_XUICoreObjects.XView.md#dom)

### Methods

- [addClass](XUI_XUICoreObjects.XView.md#addclass)
- [addEventListener](XUI_XUICoreObjects.XView.md#addeventlistener)
- [addNanoCommand](XUI_XUICoreObjects.XView.md#addnanocommand)
- [addNanoCommandPack](XUI_XUICoreObjects.XView.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XUI_XUICoreObjects.XView.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XUI_XUICoreObjects.XView.md#addxporterinstancexporter)
- [append](XUI_XUICoreObjects.XView.md#append)
- [attach](XUI_XUICoreObjects.XView.md#attach)
- [checkAndRunInternalFunction](XUI_XUICoreObjects.XView.md#checkandruninternalfunction)
- [clearAttributes](XUI_XUICoreObjects.XView.md#clearattributes)
- [click](XUI_XUICoreObjects.XView.md#click)
- [dispose](XUI_XUICoreObjects.XView.md#dispose)
- [emptyDataSource](XUI_XUICoreObjects.XView.md#emptydatasource)
- [execute](XUI_XUICoreObjects.XView.md#execute)
- [getDOMObject](XUI_XUICoreObjects.XView.md#getdomobject)
- [getHTML](XUI_XUICoreObjects.XView.md#gethtml)
- [hide](XUI_XUICoreObjects.XView.md#hide)
- [init](XUI_XUICoreObjects.XView.md#init)
- [log](XUI_XUICoreObjects.XView.md#log)
- [mount](XUI_XUICoreObjects.XView.md#mount)
- [onCreate](XUI_XUICoreObjects.XView.md#oncreate)
- [onData](XUI_XUICoreObjects.XView.md#ondata)
- [onFrame](XUI_XUICoreObjects.XView.md#onframe)
- [onHide](XUI_XUICoreObjects.XView.md#onhide)
- [onMount](XUI_XUICoreObjects.XView.md#onmount)
- [onShow](XUI_XUICoreObjects.XView.md#onshow)
- [parse](XUI_XUICoreObjects.XView.md#parse)
- [parseEvents](XUI_XUICoreObjects.XView.md#parseevents)
- [parseFields](XUI_XUICoreObjects.XView.md#parsefields)
- [parseFieldsFromXDataObject](XUI_XUICoreObjects.XView.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XUI_XUICoreObjects.XView.md#removealleventlisteners)
- [removeClass](XUI_XUICoreObjects.XView.md#removeclass)
- [removeEventListener](XUI_XUICoreObjects.XView.md#removeeventlistener)
- [replaceClass](XUI_XUICoreObjects.XView.md#replaceclass)
- [run](XUI_XUICoreObjects.XView.md#run)
- [setStyleAttribute](XUI_XUICoreObjects.XView.md#setstyleattribute)
- [setText](XUI_XUICoreObjects.XView.md#settext)
- [show](XUI_XUICoreObjects.XView.md#show)
- [toString](XUI_XUICoreObjects.XView.md#tostring)
- [toXData](XUI_XUICoreObjects.XView.md#toxdata)
- [toggle](XUI_XUICoreObjects.XView.md#toggle)
- [toggleClass](XUI_XUICoreObjects.XView.md#toggleclass)

## Constructors

### constructor

• **new XView**(`data`): [`XView`](XUI_XUICoreObjects.XView.md)

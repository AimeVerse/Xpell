[xpell](../README.md) / [Modules](../modules.md) / [XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md) / XLink

# Class: XLink

[XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md).XLink
...
- [constructor](XUI_XUICoreObjects.XLink.md#constructor)

### Properties

- [#\_text](XUI_XUICoreObjects.XLink.md##_text)
- [\_base\_display](XUI_XUICoreObjects.XLink.md#_base_display)
- [\_cache\_cmd\_txt](XUI_XUICoreObjects.XLink.md#_cache_cmd_txt)
- [\_cache\_jcmd](XUI_XUICoreObjects.XLink.md#_cache_jcmd)
- [\_children](XUI_XUICoreObjects.XLink.md#_children)
- [\_data\_source](XUI_XUICoreObjects.XLink.md#_data_source)
- [\_dom\_object](XUI_XUICoreObjects.XLink.md#_dom_object)
- [\_event\_listeners\_ids](XUI_XUICoreObjects.XLink.md#_event_listeners_ids)
- [\_html](XUI_XUICoreObjects.XLink.md#_html)
- [\_html\_ns](XUI_XUICoreObjects.XLink.md#_html_ns)
- [\_html\_tag](XUI_XUICoreObjects.XLink.md#_html_tag)
- [\_id](XUI_XUICoreObjects.XLink.md#_id)
- [\_name](XUI_XUICoreObjects.XLink.md#_name)
- [\_nano\_commands](XUI_XUICoreObjects.XLink.md#_nano_commands)
- [\_on](XUI_XUICoreObjects.XLink.md#_on)
- [\_on\_click](XUI_XUICoreObjects.XLink.md#_on_click)
- [\_on\_create](XUI_XUICoreObjects.XLink.md#_on_create)
- [\_on\_data](XUI_XUICoreObjects.XLink.md#_on_data)
- [\_on\_event](XUI_XUICoreObjects.XLink.md#_on_event)
- [\_on\_frame](XUI_XUICoreObjects.XLink.md#_on_frame)
- [\_on\_hide](XUI_XUICoreObjects.XLink.md#_on_hide)
- [\_on\_mount](XUI_XUICoreObjects.XLink.md#_on_mount)
- [\_on\_show](XUI_XUICoreObjects.XLink.md#_on_show)
- [\_once](XUI_XUICoreObjects.XLink.md#_once)
- [\_parent](XUI_XUICoreObjects.XLink.md#_parent)
- [\_parent\_element](XUI_XUICoreObjects.XLink.md#_parent_element)
- [\_process\_data](XUI_XUICoreObjects.XLink.md#_process_data)
- [\_process\_frame](XUI_XUICoreObjects.XLink.md#_process_frame)
- [\_type](XUI_XUICoreObjects.XLink.md#_type)
- [\_visible](XUI_XUICoreObjects.XLink.md#_visible)
- [\_xem\_options](XUI_XUICoreObjects.XLink.md#_xem_options)
- [\_xporter](XUI_XUICoreObjects.XLink.md#_xporter)

### Accessors

- [\_text](XUI_XUICoreObjects.XLink.md#_text)
- [dom](XUI_XUICoreObjects.XLink.md#dom)

### Methods

- [addClass](XUI_XUICoreObjects.XLink.md#addclass)
- [addEventListener](XUI_XUICoreObjects.XLink.md#addeventlistener)
- [addNanoCommand](XUI_XUICoreObjects.XLink.md#addnanocommand)
- [addNanoCommandPack](XUI_XUICoreObjects.XLink.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XUI_XUICoreObjects.XLink.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XUI_XUICoreObjects.XLink.md#addxporterinstancexporter)
- [append](XUI_XUICoreObjects.XLink.md#append)
- [attach](XUI_XUICoreObjects.XLink.md#attach)
- [checkAndRunInternalFunction](XUI_XUICoreObjects.XLink.md#checkandruninternalfunction)
- [clearAttributes](XUI_XUICoreObjects.XLink.md#clearattributes)
- [click](XUI_XUICoreObjects.XLink.md#click)
- [dispose](XUI_XUICoreObjects.XLink.md#dispose)
- [emptyDataSource](XUI_XUICoreObjects.XLink.md#emptydatasource)
- [execute](XUI_XUICoreObjects.XLink.md#execute)
- [getDOMObject](XUI_XUICoreObjects.XLink.md#getdomobject)
- [getHTML](XUI_XUICoreObjects.XLink.md#gethtml)
- [hide](XUI_XUICoreObjects.XLink.md#hide)
- [init](XUI_XUICoreObjects.XLink.md#init)
- [log](XUI_XUICoreObjects.XLink.md#log)
- [mount](XUI_XUICoreObjects.XLink.md#mount)
- [onCreate](XUI_XUICoreObjects.XLink.md#oncreate)
- [onData](XUI_XUICoreObjects.XLink.md#ondata)
- [onFrame](XUI_XUICoreObjects.XLink.md#onframe)
- [onHide](XUI_XUICoreObjects.XLink.md#onhide)
- [onMount](XUI_XUICoreObjects.XLink.md#onmount)
- [onShow](XUI_XUICoreObjects.XLink.md#onshow)
- [parse](XUI_XUICoreObjects.XLink.md#parse)
- [parseEvents](XUI_XUICoreObjects.XLink.md#parseevents)
- [parseFields](XUI_XUICoreObjects.XLink.md#parsefields)
- [parseFieldsFromXDataObject](XUI_XUICoreObjects.XLink.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XUI_XUICoreObjects.XLink.md#removealleventlisteners)
- [removeClass](XUI_XUICoreObjects.XLink.md#removeclass)
- [removeEventListener](XUI_XUICoreObjects.XLink.md#removeeventlistener)
- [replaceClass](XUI_XUICoreObjects.XLink.md#replaceclass)
- [run](XUI_XUICoreObjects.XLink.md#run)
- [setStyleAttribute](XUI_XUICoreObjects.XLink.md#setstyleattribute)
- [setText](XUI_XUICoreObjects.XLink.md#settext)
- [show](XUI_XUICoreObjects.XLink.md#show)
- [toString](XUI_XUICoreObjects.XLink.md#tostring)
- [toXData](XUI_XUICoreObjects.XLink.md#toxdata)
- [toggle](XUI_XUICoreObjects.XLink.md#toggle)
- [toggleClass](XUI_XUICoreObjects.XLink.md#toggleclass)

## Constructors

### constructor

• **new XLink**(`data`): [`XLink`](XUI_XUICoreObjects.XLink.md)

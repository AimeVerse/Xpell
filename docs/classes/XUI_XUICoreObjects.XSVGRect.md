[xpell](../README.md) / [Modules](../modules.md) / [XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md) / XSVGRect

# Class: XSVGRect

[XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md).XSVGRect
...
- [constructor](XUI_XUICoreObjects.XSVGRect.md#constructor)

### Properties

- [#\_text](XUI_XUICoreObjects.XSVGRect.md##_text)
- [\_base\_display](XUI_XUICoreObjects.XSVGRect.md#_base_display)
- [\_cache\_cmd\_txt](XUI_XUICoreObjects.XSVGRect.md#_cache_cmd_txt)
- [\_cache\_jcmd](XUI_XUICoreObjects.XSVGRect.md#_cache_jcmd)
- [\_children](XUI_XUICoreObjects.XSVGRect.md#_children)
- [\_data\_source](XUI_XUICoreObjects.XSVGRect.md#_data_source)
- [\_dom\_object](XUI_XUICoreObjects.XSVGRect.md#_dom_object)
- [\_event\_listeners\_ids](XUI_XUICoreObjects.XSVGRect.md#_event_listeners_ids)
- [\_html](XUI_XUICoreObjects.XSVGRect.md#_html)
- [\_html\_ns](XUI_XUICoreObjects.XSVGRect.md#_html_ns)
- [\_html\_tag](XUI_XUICoreObjects.XSVGRect.md#_html_tag)
- [\_id](XUI_XUICoreObjects.XSVGRect.md#_id)
- [\_name](XUI_XUICoreObjects.XSVGRect.md#_name)
- [\_nano\_commands](XUI_XUICoreObjects.XSVGRect.md#_nano_commands)
- [\_on](XUI_XUICoreObjects.XSVGRect.md#_on)
- [\_on\_click](XUI_XUICoreObjects.XSVGRect.md#_on_click)
- [\_on\_create](XUI_XUICoreObjects.XSVGRect.md#_on_create)
- [\_on\_data](XUI_XUICoreObjects.XSVGRect.md#_on_data)
- [\_on\_event](XUI_XUICoreObjects.XSVGRect.md#_on_event)
- [\_on\_frame](XUI_XUICoreObjects.XSVGRect.md#_on_frame)
- [\_on\_hide](XUI_XUICoreObjects.XSVGRect.md#_on_hide)
- [\_on\_mount](XUI_XUICoreObjects.XSVGRect.md#_on_mount)
- [\_on\_show](XUI_XUICoreObjects.XSVGRect.md#_on_show)
- [\_once](XUI_XUICoreObjects.XSVGRect.md#_once)
- [\_parent](XUI_XUICoreObjects.XSVGRect.md#_parent)
- [\_parent\_element](XUI_XUICoreObjects.XSVGRect.md#_parent_element)
- [\_process\_data](XUI_XUICoreObjects.XSVGRect.md#_process_data)
- [\_process\_frame](XUI_XUICoreObjects.XSVGRect.md#_process_frame)
- [\_svg\_data](XUI_XUICoreObjects.XSVGRect.md#_svg_data)
- [\_type](XUI_XUICoreObjects.XSVGRect.md#_type)
- [\_visible](XUI_XUICoreObjects.XSVGRect.md#_visible)
- [\_xem\_options](XUI_XUICoreObjects.XSVGRect.md#_xem_options)
- [\_xporter](XUI_XUICoreObjects.XSVGRect.md#_xporter)

### Accessors

- [\_text](XUI_XUICoreObjects.XSVGRect.md#_text)
- [dom](XUI_XUICoreObjects.XSVGRect.md#dom)

### Methods

- [addClass](XUI_XUICoreObjects.XSVGRect.md#addclass)
- [addEventListener](XUI_XUICoreObjects.XSVGRect.md#addeventlistener)
- [addNanoCommand](XUI_XUICoreObjects.XSVGRect.md#addnanocommand)
- [addNanoCommandPack](XUI_XUICoreObjects.XSVGRect.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XUI_XUICoreObjects.XSVGRect.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XUI_XUICoreObjects.XSVGRect.md#addxporterinstancexporter)
- [append](XUI_XUICoreObjects.XSVGRect.md#append)
- [attach](XUI_XUICoreObjects.XSVGRect.md#attach)
- [checkAndRunInternalFunction](XUI_XUICoreObjects.XSVGRect.md#checkandruninternalfunction)
- [clearAttributes](XUI_XUICoreObjects.XSVGRect.md#clearattributes)
- [click](XUI_XUICoreObjects.XSVGRect.md#click)
- [dispose](XUI_XUICoreObjects.XSVGRect.md#dispose)
- [emptyDataSource](XUI_XUICoreObjects.XSVGRect.md#emptydatasource)
- [execute](XUI_XUICoreObjects.XSVGRect.md#execute)
- [getDOMObject](XUI_XUICoreObjects.XSVGRect.md#getdomobject)
- [getHTML](XUI_XUICoreObjects.XSVGRect.md#gethtml)
- [hide](XUI_XUICoreObjects.XSVGRect.md#hide)
- [init](XUI_XUICoreObjects.XSVGRect.md#init)
- [log](XUI_XUICoreObjects.XSVGRect.md#log)
- [mount](XUI_XUICoreObjects.XSVGRect.md#mount)
- [onCreate](XUI_XUICoreObjects.XSVGRect.md#oncreate)
- [onData](XUI_XUICoreObjects.XSVGRect.md#ondata)
- [onFrame](XUI_XUICoreObjects.XSVGRect.md#onframe)
- [onHide](XUI_XUICoreObjects.XSVGRect.md#onhide)
- [onMount](XUI_XUICoreObjects.XSVGRect.md#onmount)
- [onShow](XUI_XUICoreObjects.XSVGRect.md#onshow)
- [parse](XUI_XUICoreObjects.XSVGRect.md#parse)
- [parseEvents](XUI_XUICoreObjects.XSVGRect.md#parseevents)
- [parseFields](XUI_XUICoreObjects.XSVGRect.md#parsefields)
- [parseFieldsFromXDataObject](XUI_XUICoreObjects.XSVGRect.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XUI_XUICoreObjects.XSVGRect.md#removealleventlisteners)
- [removeClass](XUI_XUICoreObjects.XSVGRect.md#removeclass)
- [removeEventListener](XUI_XUICoreObjects.XSVGRect.md#removeeventlistener)
- [replaceClass](XUI_XUICoreObjects.XSVGRect.md#replaceclass)
- [run](XUI_XUICoreObjects.XSVGRect.md#run)
- [setStyleAttribute](XUI_XUICoreObjects.XSVGRect.md#setstyleattribute)
- [setText](XUI_XUICoreObjects.XSVGRect.md#settext)
- [show](XUI_XUICoreObjects.XSVGRect.md#show)
- [toString](XUI_XUICoreObjects.XSVGRect.md#tostring)
- [toXData](XUI_XUICoreObjects.XSVGRect.md#toxdata)
- [toggle](XUI_XUICoreObjects.XSVGRect.md#toggle)
- [toggleClass](XUI_XUICoreObjects.XSVGRect.md#toggleclass)

## Constructors

### constructor

• **new XSVGRect**(`data`): [`XSVGRect`](XUI_XUICoreObjects.XSVGRect.md)

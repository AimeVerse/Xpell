[xpell](../README.md) / [Modules](../modules.md) / [XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md) / XTextField

# Class: XTextField

[XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md).XTextField
...
- [constructor](XUI_XUICoreObjects.XTextField.md#constructor)

### Properties

- [#\_text](XUI_XUICoreObjects.XTextField.md##_text)
- [\_base\_display](XUI_XUICoreObjects.XTextField.md#_base_display)
- [\_cache\_cmd\_txt](XUI_XUICoreObjects.XTextField.md#_cache_cmd_txt)
- [\_cache\_jcmd](XUI_XUICoreObjects.XTextField.md#_cache_jcmd)
- [\_children](XUI_XUICoreObjects.XTextField.md#_children)
- [\_data\_source](XUI_XUICoreObjects.XTextField.md#_data_source)
- [\_dom\_object](XUI_XUICoreObjects.XTextField.md#_dom_object)
- [\_event\_listeners\_ids](XUI_XUICoreObjects.XTextField.md#_event_listeners_ids)
- [\_html](XUI_XUICoreObjects.XTextField.md#_html)
- [\_html\_ns](XUI_XUICoreObjects.XTextField.md#_html_ns)
- [\_html\_tag](XUI_XUICoreObjects.XTextField.md#_html_tag)
- [\_id](XUI_XUICoreObjects.XTextField.md#_id)
- [\_name](XUI_XUICoreObjects.XTextField.md#_name)
- [\_nano\_commands](XUI_XUICoreObjects.XTextField.md#_nano_commands)
- [\_on](XUI_XUICoreObjects.XTextField.md#_on)
- [\_on\_click](XUI_XUICoreObjects.XTextField.md#_on_click)
- [\_on\_create](XUI_XUICoreObjects.XTextField.md#_on_create)
- [\_on\_data](XUI_XUICoreObjects.XTextField.md#_on_data)
- [\_on\_event](XUI_XUICoreObjects.XTextField.md#_on_event)
- [\_on\_frame](XUI_XUICoreObjects.XTextField.md#_on_frame)
- [\_on\_hide](XUI_XUICoreObjects.XTextField.md#_on_hide)
- [\_on\_mount](XUI_XUICoreObjects.XTextField.md#_on_mount)
- [\_on\_show](XUI_XUICoreObjects.XTextField.md#_on_show)
- [\_once](XUI_XUICoreObjects.XTextField.md#_once)
- [\_parent](XUI_XUICoreObjects.XTextField.md#_parent)
- [\_parent\_element](XUI_XUICoreObjects.XTextField.md#_parent_element)
- [\_process\_data](XUI_XUICoreObjects.XTextField.md#_process_data)
- [\_process\_frame](XUI_XUICoreObjects.XTextField.md#_process_frame)
- [\_type](XUI_XUICoreObjects.XTextField.md#_type)
- [\_visible](XUI_XUICoreObjects.XTextField.md#_visible)
- [\_xem\_options](XUI_XUICoreObjects.XTextField.md#_xem_options)
- [\_xporter](XUI_XUICoreObjects.XTextField.md#_xporter)

### Accessors

- [\_text](XUI_XUICoreObjects.XTextField.md#_text)
- [dom](XUI_XUICoreObjects.XTextField.md#dom)

### Methods

- [addClass](XUI_XUICoreObjects.XTextField.md#addclass)
- [addEventListener](XUI_XUICoreObjects.XTextField.md#addeventlistener)
- [addNanoCommand](XUI_XUICoreObjects.XTextField.md#addnanocommand)
- [addNanoCommandPack](XUI_XUICoreObjects.XTextField.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XUI_XUICoreObjects.XTextField.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XUI_XUICoreObjects.XTextField.md#addxporterinstancexporter)
- [append](XUI_XUICoreObjects.XTextField.md#append)
- [attach](XUI_XUICoreObjects.XTextField.md#attach)
- [checkAndRunInternalFunction](XUI_XUICoreObjects.XTextField.md#checkandruninternalfunction)
- [clearAttributes](XUI_XUICoreObjects.XTextField.md#clearattributes)
- [click](XUI_XUICoreObjects.XTextField.md#click)
- [dispose](XUI_XUICoreObjects.XTextField.md#dispose)
- [emptyDataSource](XUI_XUICoreObjects.XTextField.md#emptydatasource)
- [execute](XUI_XUICoreObjects.XTextField.md#execute)
- [getDOMObject](XUI_XUICoreObjects.XTextField.md#getdomobject)
- [getHTML](XUI_XUICoreObjects.XTextField.md#gethtml)
- [hide](XUI_XUICoreObjects.XTextField.md#hide)
- [init](XUI_XUICoreObjects.XTextField.md#init)
- [log](XUI_XUICoreObjects.XTextField.md#log)
- [mount](XUI_XUICoreObjects.XTextField.md#mount)
- [onCreate](XUI_XUICoreObjects.XTextField.md#oncreate)
- [onData](XUI_XUICoreObjects.XTextField.md#ondata)
- [onFrame](XUI_XUICoreObjects.XTextField.md#onframe)
- [onHide](XUI_XUICoreObjects.XTextField.md#onhide)
- [onMount](XUI_XUICoreObjects.XTextField.md#onmount)
- [onShow](XUI_XUICoreObjects.XTextField.md#onshow)
- [parse](XUI_XUICoreObjects.XTextField.md#parse)
- [parseEvents](XUI_XUICoreObjects.XTextField.md#parseevents)
- [parseFields](XUI_XUICoreObjects.XTextField.md#parsefields)
- [parseFieldsFromXDataObject](XUI_XUICoreObjects.XTextField.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XUI_XUICoreObjects.XTextField.md#removealleventlisteners)
- [removeClass](XUI_XUICoreObjects.XTextField.md#removeclass)
- [removeEventListener](XUI_XUICoreObjects.XTextField.md#removeeventlistener)
- [replaceClass](XUI_XUICoreObjects.XTextField.md#replaceclass)
- [run](XUI_XUICoreObjects.XTextField.md#run)
- [setStyleAttribute](XUI_XUICoreObjects.XTextField.md#setstyleattribute)
- [setText](XUI_XUICoreObjects.XTextField.md#settext)
- [show](XUI_XUICoreObjects.XTextField.md#show)
- [toString](XUI_XUICoreObjects.XTextField.md#tostring)
- [toXData](XUI_XUICoreObjects.XTextField.md#toxdata)
- [toggle](XUI_XUICoreObjects.XTextField.md#toggle)
- [toggleClass](XUI_XUICoreObjects.XTextField.md#toggleclass)

## Constructors

### constructor

• **new XTextField**(`data`): [`XTextField`](XUI_XUICoreObjects.XTextField.md)

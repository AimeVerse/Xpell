[xpell](../README.md) / [Modules](../modules.md) / [XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md) / XInput

# Class: XInput

[XUI/XUICoreObjects](../modules/XUI_XUICoreObjects.md).XInput
...
- [constructor](XUI_XUICoreObjects.XInput.md#constructor)

### Properties

- [#\_text](XUI_XUICoreObjects.XInput.md##_text)
- [\_base\_display](XUI_XUICoreObjects.XInput.md#_base_display)
- [\_cache\_cmd\_txt](XUI_XUICoreObjects.XInput.md#_cache_cmd_txt)
- [\_cache\_jcmd](XUI_XUICoreObjects.XInput.md#_cache_jcmd)
- [\_children](XUI_XUICoreObjects.XInput.md#_children)
- [\_data\_source](XUI_XUICoreObjects.XInput.md#_data_source)
- [\_dom\_object](XUI_XUICoreObjects.XInput.md#_dom_object)
- [\_event\_listeners\_ids](XUI_XUICoreObjects.XInput.md#_event_listeners_ids)
- [\_html](XUI_XUICoreObjects.XInput.md#_html)
- [\_html\_ns](XUI_XUICoreObjects.XInput.md#_html_ns)
- [\_html\_tag](XUI_XUICoreObjects.XInput.md#_html_tag)
- [\_id](XUI_XUICoreObjects.XInput.md#_id)
- [\_name](XUI_XUICoreObjects.XInput.md#_name)
- [\_nano\_commands](XUI_XUICoreObjects.XInput.md#_nano_commands)
- [\_on](XUI_XUICoreObjects.XInput.md#_on)
- [\_on\_click](XUI_XUICoreObjects.XInput.md#_on_click)
- [\_on\_create](XUI_XUICoreObjects.XInput.md#_on_create)
- [\_on\_data](XUI_XUICoreObjects.XInput.md#_on_data)
- [\_on\_event](XUI_XUICoreObjects.XInput.md#_on_event)
- [\_on\_frame](XUI_XUICoreObjects.XInput.md#_on_frame)
- [\_on\_hide](XUI_XUICoreObjects.XInput.md#_on_hide)
- [\_on\_mount](XUI_XUICoreObjects.XInput.md#_on_mount)
- [\_on\_show](XUI_XUICoreObjects.XInput.md#_on_show)
- [\_once](XUI_XUICoreObjects.XInput.md#_once)
- [\_parent](XUI_XUICoreObjects.XInput.md#_parent)
- [\_parent\_element](XUI_XUICoreObjects.XInput.md#_parent_element)
- [\_process\_data](XUI_XUICoreObjects.XInput.md#_process_data)
- [\_process\_frame](XUI_XUICoreObjects.XInput.md#_process_frame)
- [\_type](XUI_XUICoreObjects.XInput.md#_type)
- [\_visible](XUI_XUICoreObjects.XInput.md#_visible)
- [\_xem\_options](XUI_XUICoreObjects.XInput.md#_xem_options)
- [\_xporter](XUI_XUICoreObjects.XInput.md#_xporter)

### Accessors

- [\_text](XUI_XUICoreObjects.XInput.md#_text)
- [dom](XUI_XUICoreObjects.XInput.md#dom)

### Methods

- [addClass](XUI_XUICoreObjects.XInput.md#addclass)
- [addEventListener](XUI_XUICoreObjects.XInput.md#addeventlistener)
- [addNanoCommand](XUI_XUICoreObjects.XInput.md#addnanocommand)
- [addNanoCommandPack](XUI_XUICoreObjects.XInput.md#addnanocommandpack)
- [addXporterDataIgnoreFields](XUI_XUICoreObjects.XInput.md#addxporterdataignorefields)
- [addXporterInstanceXporter](XUI_XUICoreObjects.XInput.md#addxporterinstancexporter)
- [append](XUI_XUICoreObjects.XInput.md#append)
- [attach](XUI_XUICoreObjects.XInput.md#attach)
- [checkAndRunInternalFunction](XUI_XUICoreObjects.XInput.md#checkandruninternalfunction)
- [clearAttributes](XUI_XUICoreObjects.XInput.md#clearattributes)
- [click](XUI_XUICoreObjects.XInput.md#click)
- [dispose](XUI_XUICoreObjects.XInput.md#dispose)
- [emptyDataSource](XUI_XUICoreObjects.XInput.md#emptydatasource)
- [execute](XUI_XUICoreObjects.XInput.md#execute)
- [getDOMObject](XUI_XUICoreObjects.XInput.md#getdomobject)
- [getHTML](XUI_XUICoreObjects.XInput.md#gethtml)
- [hide](XUI_XUICoreObjects.XInput.md#hide)
- [init](XUI_XUICoreObjects.XInput.md#init)
- [log](XUI_XUICoreObjects.XInput.md#log)
- [mount](XUI_XUICoreObjects.XInput.md#mount)
- [onCreate](XUI_XUICoreObjects.XInput.md#oncreate)
- [onData](XUI_XUICoreObjects.XInput.md#ondata)
- [onFrame](XUI_XUICoreObjects.XInput.md#onframe)
- [onHide](XUI_XUICoreObjects.XInput.md#onhide)
- [onMount](XUI_XUICoreObjects.XInput.md#onmount)
- [onShow](XUI_XUICoreObjects.XInput.md#onshow)
- [parse](XUI_XUICoreObjects.XInput.md#parse)
- [parseEvents](XUI_XUICoreObjects.XInput.md#parseevents)
- [parseFields](XUI_XUICoreObjects.XInput.md#parsefields)
- [parseFieldsFromXDataObject](XUI_XUICoreObjects.XInput.md#parsefieldsfromxdataobject)
- [removeAllEventListeners](XUI_XUICoreObjects.XInput.md#removealleventlisteners)
- [removeClass](XUI_XUICoreObjects.XInput.md#removeclass)
- [removeEventListener](XUI_XUICoreObjects.XInput.md#removeeventlistener)
- [replaceClass](XUI_XUICoreObjects.XInput.md#replaceclass)
- [run](XUI_XUICoreObjects.XInput.md#run)
- [setStyleAttribute](XUI_XUICoreObjects.XInput.md#setstyleattribute)
- [setText](XUI_XUICoreObjects.XInput.md#settext)
- [show](XUI_XUICoreObjects.XInput.md#show)
- [toString](XUI_XUICoreObjects.XInput.md#tostring)
- [toXData](XUI_XUICoreObjects.XInput.md#toxdata)
- [toggle](XUI_XUICoreObjects.XInput.md#toggle)
- [toggleClass](XUI_XUICoreObjects.XInput.md#toggleclass)

## Constructors

### constructor

• **new XInput**(`data`): [`XInput`](XUI_XUICoreObjects.XInput.md)

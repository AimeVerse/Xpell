...
[XUI/XUICoreObjects](../wiki/XUI.XUICoreObjects).XHeader
...
- [constructor](../wiki/XUI.XUICoreObjects.XHeader#constructor)

### Properties

- [\_base\_display](../wiki/XUI.XUICoreObjects.XHeader#_base_display)
- [\_children](../wiki/XUI.XUICoreObjects.XHeader#_children)
- [\_data\_source](../wiki/XUI.XUICoreObjects.XHeader#_data_source)
- [\_format](../wiki/XUI.XUICoreObjects.XHeader#_format)
- [\_html](../wiki/XUI.XUICoreObjects.XHeader#_html)
- [\_html\_ns](../wiki/XUI.XUICoreObjects.XHeader#_html_ns)
- [\_html\_tag](../wiki/XUI.XUICoreObjects.XHeader#_html_tag)
- [\_ignore](../wiki/XUI.XUICoreObjects.XHeader#_ignore)
- [\_on\_frame\_skip\_data\_source](../wiki/XUI.XUICoreObjects.XHeader#_on_frame_skip_data_source)
- [\_type](../wiki/XUI.XUICoreObjects.XHeader#_type)
- [text](../wiki/XUI.XUICoreObjects.XHeader#text)

### Accessors

- [DOMElementFromHTML](../wiki/XUI.XUICoreObjects.XHeader#domelementfromhtml)

### Methods

- [append](../wiki/XUI.XUICoreObjects.XHeader#append)
- [attach](../wiki/XUI.XUICoreObjects.XHeader#attach)
- [execute](../wiki/XUI.XUICoreObjects.XHeader#execute)
- [getDOMObject](../wiki/XUI.XUICoreObjects.XHeader#getdomobject)
- [getHTML](../wiki/XUI.XUICoreObjects.XHeader#gethtml)
- [hide](../wiki/XUI.XUICoreObjects.XHeader#hide)
- [init](../wiki/XUI.XUICoreObjects.XHeader#init)
- [log](../wiki/XUI.XUICoreObjects.XHeader#log)
- [onCreate](../wiki/XUI.XUICoreObjects.XHeader#oncreate)
- [onFrame](../wiki/XUI.XUICoreObjects.XHeader#onframe)
- [onMount](../wiki/XUI.XUICoreObjects.XHeader#onmount)
- [parse](../wiki/XUI.XUICoreObjects.XHeader#parse)
- [setStyle](../wiki/XUI.XUICoreObjects.XHeader#setstyle)
- [setText](../wiki/XUI.XUICoreObjects.XHeader#settext)
- [show](../wiki/XUI.XUICoreObjects.XHeader#show)

...
[XUI/XUICoreObjects](../wiki/XUI.XUICoreObjects).XForm
...
- [constructor](../wiki/XUI.XUICoreObjects.XForm#constructor)

### Properties

- [\_base\_display](../wiki/XUI.XUICoreObjects.XForm#_base_display)
- [\_children](../wiki/XUI.XUICoreObjects.XForm#_children)
- [\_data\_source](../wiki/XUI.XUICoreObjects.XForm#_data_source)
- [\_format](../wiki/XUI.XUICoreObjects.XForm#_format)
- [\_html](../wiki/XUI.XUICoreObjects.XForm#_html)
- [\_html\_ns](../wiki/XUI.XUICoreObjects.XForm#_html_ns)
- [\_html\_tag](../wiki/XUI.XUICoreObjects.XForm#_html_tag)
- [\_ignore](../wiki/XUI.XUICoreObjects.XForm#_ignore)
- [\_on\_frame\_skip\_data\_source](../wiki/XUI.XUICoreObjects.XForm#_on_frame_skip_data_source)
- [\_type](../wiki/XUI.XUICoreObjects.XForm#_type)
- [text](../wiki/XUI.XUICoreObjects.XForm#text)

### Accessors

- [DOMElementFromHTML](../wiki/XUI.XUICoreObjects.XForm#domelementfromhtml)

### Methods

- [append](../wiki/XUI.XUICoreObjects.XForm#append)
- [attach](../wiki/XUI.XUICoreObjects.XForm#attach)
- [execute](../wiki/XUI.XUICoreObjects.XForm#execute)
- [getDOMObject](../wiki/XUI.XUICoreObjects.XForm#getdomobject)
- [getHTML](../wiki/XUI.XUICoreObjects.XForm#gethtml)
- [hide](../wiki/XUI.XUICoreObjects.XForm#hide)
- [init](../wiki/XUI.XUICoreObjects.XForm#init)
- [log](../wiki/XUI.XUICoreObjects.XForm#log)
- [onCreate](../wiki/XUI.XUICoreObjects.XForm#oncreate)
- [onFrame](../wiki/XUI.XUICoreObjects.XForm#onframe)
- [onMount](../wiki/XUI.XUICoreObjects.XForm#onmount)
- [parse](../wiki/XUI.XUICoreObjects.XForm#parse)
- [setStyle](../wiki/XUI.XUICoreObjects.XForm#setstyle)
- [setText](../wiki/XUI.XUICoreObjects.XForm#settext)
- [show](../wiki/XUI.XUICoreObjects.XForm#show)

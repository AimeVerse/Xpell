...
[XUI/XUICoreObjects](../wiki/XUI.XUICoreObjects).XInput
...
- [constructor](../wiki/XUI.XUICoreObjects.XInput#constructor)

### Properties

- [\_base\_display](../wiki/XUI.XUICoreObjects.XInput#_base_display)
- [\_children](../wiki/XUI.XUICoreObjects.XInput#_children)
- [\_data\_source](../wiki/XUI.XUICoreObjects.XInput#_data_source)
- [\_format](../wiki/XUI.XUICoreObjects.XInput#_format)
- [\_html](../wiki/XUI.XUICoreObjects.XInput#_html)
- [\_html\_ns](../wiki/XUI.XUICoreObjects.XInput#_html_ns)
- [\_html\_tag](../wiki/XUI.XUICoreObjects.XInput#_html_tag)
- [\_ignore](../wiki/XUI.XUICoreObjects.XInput#_ignore)
- [\_on\_frame\_skip\_data\_source](../wiki/XUI.XUICoreObjects.XInput#_on_frame_skip_data_source)
- [\_type](../wiki/XUI.XUICoreObjects.XInput#_type)
- [text](../wiki/XUI.XUICoreObjects.XInput#text)

### Accessors

- [DOMElementFromHTML](../wiki/XUI.XUICoreObjects.XInput#domelementfromhtml)

### Methods

- [append](../wiki/XUI.XUICoreObjects.XInput#append)
- [attach](../wiki/XUI.XUICoreObjects.XInput#attach)
- [execute](../wiki/XUI.XUICoreObjects.XInput#execute)
- [getDOMObject](../wiki/XUI.XUICoreObjects.XInput#getdomobject)
- [getHTML](../wiki/XUI.XUICoreObjects.XInput#gethtml)
- [hide](../wiki/XUI.XUICoreObjects.XInput#hide)
- [init](../wiki/XUI.XUICoreObjects.XInput#init)
- [log](../wiki/XUI.XUICoreObjects.XInput#log)
- [onCreate](../wiki/XUI.XUICoreObjects.XInput#oncreate)
- [onFrame](../wiki/XUI.XUICoreObjects.XInput#onframe)
- [onMount](../wiki/XUI.XUICoreObjects.XInput#onmount)
- [parse](../wiki/XUI.XUICoreObjects.XInput#parse)
- [setStyle](../wiki/XUI.XUICoreObjects.XInput#setstyle)
- [setText](../wiki/XUI.XUICoreObjects.XInput#settext)
- [show](../wiki/XUI.XUICoreObjects.XInput#show)

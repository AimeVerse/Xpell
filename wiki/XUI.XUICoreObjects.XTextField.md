...
[XUI/XUICoreObjects](../wiki/XUI.XUICoreObjects).XTextField
...
- [constructor](../wiki/XUI.XUICoreObjects.XTextField#constructor)

### Properties

- [\_base\_display](../wiki/XUI.XUICoreObjects.XTextField#_base_display)
- [\_children](../wiki/XUI.XUICoreObjects.XTextField#_children)
- [\_data\_source](../wiki/XUI.XUICoreObjects.XTextField#_data_source)
- [\_format](../wiki/XUI.XUICoreObjects.XTextField#_format)
- [\_html](../wiki/XUI.XUICoreObjects.XTextField#_html)
- [\_html\_ns](../wiki/XUI.XUICoreObjects.XTextField#_html_ns)
- [\_html\_tag](../wiki/XUI.XUICoreObjects.XTextField#_html_tag)
- [\_ignore](../wiki/XUI.XUICoreObjects.XTextField#_ignore)
- [\_on\_frame\_skip\_data\_source](../wiki/XUI.XUICoreObjects.XTextField#_on_frame_skip_data_source)
- [\_type](../wiki/XUI.XUICoreObjects.XTextField#_type)
- [text](../wiki/XUI.XUICoreObjects.XTextField#text)

### Accessors

- [DOMElementFromHTML](../wiki/XUI.XUICoreObjects.XTextField#domelementfromhtml)

### Methods

- [append](../wiki/XUI.XUICoreObjects.XTextField#append)
- [attach](../wiki/XUI.XUICoreObjects.XTextField#attach)
- [execute](../wiki/XUI.XUICoreObjects.XTextField#execute)
- [getDOMObject](../wiki/XUI.XUICoreObjects.XTextField#getdomobject)
- [getHTML](../wiki/XUI.XUICoreObjects.XTextField#gethtml)
- [hide](../wiki/XUI.XUICoreObjects.XTextField#hide)
- [init](../wiki/XUI.XUICoreObjects.XTextField#init)
- [log](../wiki/XUI.XUICoreObjects.XTextField#log)
- [onCreate](../wiki/XUI.XUICoreObjects.XTextField#oncreate)
- [onFrame](../wiki/XUI.XUICoreObjects.XTextField#onframe)
- [onMount](../wiki/XUI.XUICoreObjects.XTextField#onmount)
- [parse](../wiki/XUI.XUICoreObjects.XTextField#parse)
- [setStyle](../wiki/XUI.XUICoreObjects.XTextField#setstyle)
- [setText](../wiki/XUI.XUICoreObjects.XTextField#settext)
- [show](../wiki/XUI.XUICoreObjects.XTextField#show)
